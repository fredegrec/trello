...
ORIGIN = 'http://209.97.150.98:5000' # server address where the bot code is running(domain or http://ip:port), you need to insert it into allowed origins of the  trello's admin's account on the page https://trello.com/app-key
HOST = '209.97.150.98' #server IP where the bot code is running
PORT = 5000 # port, where bot's server listen
